        ...
        return array_merge(parent::behaviors(), [
            ...
            [
                ...
                'actions' => [
                    ...
                    'reboot' => 'server.power-management',
                    'shutdown' => 'server.power-management',
                    'power-on' => 'server.power-management',
                    'power-off' => 'server.power-management',
                    'reset' => 'server.power-management',
                    'reinstall' => 'server.system-management',
                    'boot-live' => 'server.system-management',
                    'enable-wizzard' => 'server.update',
                    'disable-wizzard' => 'server.wizzard',
                    'enable-vnc' => 'server.system-management',
