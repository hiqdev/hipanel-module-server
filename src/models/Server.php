...
class Server extends \hipanel\base\Model
{
    ...
    public function attributeLabels()
    {
        return $this->mergeAttributeLabels([
            ...
            'dc_like'             => Yii::t('hipanel/server', 'DC'),
            'net'                 => Yii::t('hipanel/server', 'Switch'),
            'kvm'                 => Yii::t('hipanel/server', 'KVM'),
            'pdu'                 => Yii::t('hipanel/server', 'APC'),
            'rack'                => Yii::t('hipanel/server', 'Rack'),
            'net_like'            => Yii::t('hipanel/server', 'Switch'),
            'kvm_like'            => Yii::t('hipanel/server', 'KVM'),
            'pdu_like'            => Yii::t('hipanel/server', 'APC'),
            ...
            'ip_like'             => Yii::t('hipanel/server', 'IPs'),
